...
?>
<!DOCTYPE html>
<html lang="fr"><head><meta charset="UTF-8"><script src="https://cdn.tailwindcss.com"></script><title>Connexion Client</title></head>
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
<div class="bg-white p-8 rounded-lg shadow-md w-96">
    <h2 class="text-2xl font-bold mb-4 text-center">Connexion Client</h2>
    <form method="post" class="space-y-4">
        ...
        <button type="submit" class="w-full bg-green-500 text-white py-2 rounded">Se connecter</button>
    </form>
